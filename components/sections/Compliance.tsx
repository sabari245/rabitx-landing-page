    ...
    <section className="py-20 bg-blue-50/30">
      <div className="container-custom max-w-4xl flex flex-col md:flex-row items-center gap-8">
         ...
         <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold mb-4">RabitX is secure and compliant with regulations</h2>
            <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
               RabitX is a global digital asset and Web3 infrastructure provider, operated by OMOLLO (Saint Vincent & the Grenadines, ID: 1547) globally, with operations in India and Europe through affiliated registered entities.
            </p>
